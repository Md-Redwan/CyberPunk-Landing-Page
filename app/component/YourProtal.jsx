...
const YourProtal = () => {
  return (
    <div>
      <div className="container mx-auto border-x-2 border-amber-600 px-22 pt-24 pb-32 flex gap-25">
        <div className="w-[50%]">
          <Image
            src="/ProtalSectionImg.png"
            width={614}
            height={598}
        ...
        <div className="w-[50%]">
          <h1 className="font-bold text-[55px] leading-17">
            Your{" "}
